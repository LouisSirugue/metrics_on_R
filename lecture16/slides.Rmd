...
<ul>
  <li>In Part I: <b>formal lectures</b>:</li>
  <ul>
...
```{r, echo = F}
s2 <- data.frame(a = c(paste("Lecture", 1:4), "Lecture 5-6", paste("Lecture", 7:15)),
...
<ul>
  <li>In Part II: <b>follow-ups</b> and <b>reports/presentations</b></li>
</ul>
]
...
kable(s2 %>% filter(row_number() > 3), col.names = NULL, caption = "<b>Part 2: Research project</b>")  %>%
  kable_styling(bootstrap_options = c("hover", "condensed")) %>%
  row_spec(c(1, 6, 11), bold = T, italic = T)
```
]

---

<h3>Today: How to conduct a research project</h3>
...
<ul style = "margin-left:1.5cm;list-style: none">
  <li><b>1. Preliminary steps</b></li>
  <ul style = "list-style: none">
    <li>1.1. Research question</li>
    <li>1.2. Finding data</li>
    <li>1.3. Literature review</li>
  </ul>
</ul>
...
<ul style = "margin-left:1.5cm;list-style: none">
  <li><b>2. Data description</b></li>
  <ul style = "list-style: none">
    <li>2.1. Data cleaning</li>
    <li>2.2. Descriptive statistics</li>
...
<ul style = "margin-left:-1cm;list-style: none">
  <li><b>3. Analysis</b></li>
  <ul style = "list-style: none">
    <li>3.1. Regression analysis</li>
    <li>3.2. Robustness</li>
    <li>3.3. Heterogeneity</li>
  </ul>
</ul>
...
<ul>
  <li>Academic journals ask authors to share their data more and more systematically</li>
  <ul>
    <li>The <b>academic literature</b> is a great source of data</li>
...
<ul>
  ...
  <ul>
    ...
    <li>Browse the available datasets and check the corresponding articles, this may give you inspiration</li>
  </ul>
</ul>
...
<ul>
  ...
  <ul>
    ...
    <li>We need to know were the research idea stands with respect to the existing literature</li>
  </ul>
</ul>
...
<ul>
  ...
  <ul>
    ...
    <li>Take a look at the research project example available <a href="https://louissirugue.github.io/metrics_on_R/project/example.html">here</a> to see what it should look like</li>
  </ul>
</ul>
...
<ul>
  <li>The <b>first</b> thing to do with the <b>data</b> is to <b>clean</b> it</li>
  <ul>
...
<ul>
  <li>Here is what we can do already:</li>
  <ul>
    <li>Divide the score variable into two variables, for home and away</li>
    <li>Create a variable indicating who won</li>
    <li>Recode the Time variable as numeric</li>
  </ul>
</ul>
...
```{r, echo = F}
datatable(data_match, width = '100%', options = list(scrollX = TRUE, pageLength = 5))
```
...
<ul>
  <li><b>Between each week</b> of competition there is a <b>empty line</b> with missing values</li>
  <ul>
    <li>These rows are not actual observations so we should <b>delete</b> them</li>
  </ul>
</ul>
...
<ul>
  <li>There is no missing value except for the <b>Attendance</b> variable that has <b>many NAs</b></li>
  <ul>
    <li>This is suspicious, we should <b>investigate</b> more</li>
  </ul>
</ul>
...
<ul>
  ...
  <ul>
    ...
    <li>These <b>NAs</b> for attendance may actually <b>mean 0 attendance</b></li>
...
<center><i>(code in the <a href="https://louissirugue.github.io/metrics_on_R/project/example.html">research project example</a>)</i></center>
...
<ul>
  ...
  <ul>
    <li><i>(code in the <a href="https://louissirugue.github.io/metrics_on_R/project/example.html">research project example</a>)</i>
  </ul>
</ul>
...
<ul>
  <li>It will be <b>graded</b> (detailed grading scheme <a href="https://louissirugue.github.io/metrics_on_R/project/grading.html">here</a>):</li>
  <ul>
    <li>25% of the grade on this presentation</li>
    <li>30% of the grade on the midterm report</li>
    <li>45% of the grade on the final research project/presentation</li>
  </ul>
</ul>
...
<center><b><i>Please go through the <a href="https://louissirugue.github.io/metrics_on_R/project/example.html">example</a> to get familiar with what is expected from you</i></b></center>
