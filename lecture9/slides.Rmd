...
<ul>
  ...
  <ul>
    ...
    <li>But the closer from <b>Paris</b> the higher the <b>rents</b> and the <b>ring-road</b></li>
...
<ul>
  ...
  <ul>
    ...
    <li>This <b>nets out</b> the relationship of \(x\) and \(y\) from the potential <b>confounding effect</b> of this variable</li>
    <li>This is why we call it <b>controlling for something</b></li>
  </ul>
</ul>
...
$$\begin{align}
\text{Income}_i = \:& \hat{\alpha} + \hat{\beta_1}\text{Children}_i + & \small{\text{Baseline equation}}\\ 
& \hat{\beta_2}\text{(<Highschool)}_i + \hat{\beta_3}\text{Highschool}_i+ \hat{\beta_4}\text{College}_i+& \small{\text{Allow for} \neq \text{slopes}} \\ 
& \text{Children}_i\times\left[\hat{\beta_5}\text{(<Highschool)}_i + \hat{\beta_6}\text{Highschool}_i+ \hat{\beta_7}\text{College}_i\right]+\hat{\varepsilon_i}& \small{\text{Allow for} \neq \text{intercepts}}\end{align}$$
...
$$\begin{align}
\text{Income}_i = \:& \hat{\alpha} + \hat{\beta_1}\text{Children}_i + & \small{\text{Baseline equation}}\\ 
& \hat{\beta_2}\underbrace{\text{(<Highschool)}_i}_{1} + \hat{\beta_3}\underbrace{\text{Highschool}_i}_{0}+ \hat{\beta_4}\underbrace{\text{College}_i}_{0}+& \small{\text{Allow for} \neq \text{slopes}} \\ 
& \text{Children}_i\times\left[\hat{\beta_5}\underbrace{\text{(<Highschool)}_i}_{1} + \hat{\beta_6}\underbrace{\text{Highschool}_i}_{0}+ \hat{\beta_7}\underbrace{\text{College}_i}_{0}\right]+\hat{\varepsilon_i}& \small{\text{Allow for} \neq \text{intercepts}}\end{align}$$

<p style = "margin-bottom:2cm;"></p>

<ul style = "list-style: none; margin-left: 5cm;">
  <li><b>< Highschool:</b> \(\:\:\: \text{Income}_i = (\hat{\alpha} + \hat{\beta_2}) + (\hat{\beta_1} + \hat{\beta_5})\text{Children}_i+\hat{\varepsilon_i}\)</li>
</ul>
...
$$\begin{align}
\text{Income}_i = \:& \hat{\alpha} + \hat{\beta_1}\text{Children}_i + & \small{\text{Baseline equation}}\\ 
& \hat{\beta_2}\underbrace{\text{(<Highschool)}_i}_{0} + \hat{\beta_3}\underbrace{\text{Highschool}_i}_{1}+ \hat{\beta_4}\underbrace{\text{College}_i}_{0}+& \small{\text{Allow for} \neq \text{slopes}} \\ 
& \text{Children}_i\times\left[\hat{\beta_5}\underbrace{\text{(<Highschool)}_i}_{0} + \hat{\beta_6}\underbrace{\text{Highschool}_i}_{1}+ \hat{\beta_7}\underbrace{\text{College}_i}_{0}\right]+\hat{\varepsilon_i}& \small{\text{Allow for} \neq \text{intercepts}}\end{align}$$

<p style = "margin-bottom:2cm;"></p>

<ul style = "list-style: none; margin-left: 5cm;">
  <li><b>Highschool:</b> \(\:\:\: \text{Income}_i = (\hat{\alpha} + \hat{\beta_3}) + (\hat{\beta_1} + \hat{\beta_6})\text{Children}_i+\hat{\varepsilon_i}\)</li>
</ul>
...
$$\begin{align}
\text{Income}_i = \:& \hat{\alpha} + \hat{\beta_1}\text{Children}_i + & \small{\text{Baseline equation}}\\ 
& \hat{\beta_2}\underbrace{\text{(<Highschool)}_i}_{0} + \hat{\beta_3}\underbrace{\text{Highschool}_i}_{0}+ \hat{\beta_4}\underbrace{\text{College}_i}_{1}+& \small{\text{Allow for} \neq \text{slopes}} \\ 
& \text{Children}_i\times\left[\hat{\beta_5}\underbrace{\text{(<Highschool)}_i}_{0} + \hat{\beta_6}\underbrace{\text{Highschool}_i}_{0}+ \hat{\beta_7}\underbrace{\text{College}_i}_{1}\right]+\hat{\varepsilon_i}& \small{\text{Allow for} \neq \text{intercepts}}\end{align}$$

<p style = "margin-bottom:2cm;"></p>

<ul style = "list-style: none; margin-left: 5cm;">
  <li><b>College:</b> \(\:\:\: \text{Income}_i = (\hat{\alpha} + \hat{\beta_4}) + (\hat{\beta_1} + \hat{\beta_7})\text{Children}_i+\hat{\varepsilon_i}\)</li>
</ul>
...
<ul>
  <li>What is the <b>effect of</b> 1-unit increase in <b>income here?</b></li>
</ul>
...
<ul>
  ...
  <ul>
    <li>By how the <b>effect</b> of a one unit increase in <b>income</b> on pollution <b>varies with distance</b></li>
...
<ul>
  ...
  <ul>
    <li>Adding a third variable would fit an hyperplane of dimension 3 and so on</li>
  </ul>
</ul>
