...
<ul>
  ...
  <ul>
    ...
    <li>Log in using the verification code I sent you via email</li>
    ...
    <li>To submit click on <i>download results</i> and <b>send the downloaded file</b> to me by email</li>
  </ul>
</ul> 
...
<ul>
  ...
  <ul>
    ...
    <li>Must be handed over via email by the end of the sixth week <b>(16th of October 23:59)</b></li>
    <li><b>Late submissions will be penalized</b> by half a point for each 30min beyond the deadline</li>
    <li>I encourage you to <b>work on it progressively</b> as we go the trough the course</li>
...
<ul>
  ...
  <ul>
    ...
    <li>Follow-ups are <b>group meetings</b> with a T.A.</li>
