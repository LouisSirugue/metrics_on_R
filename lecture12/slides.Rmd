...
<ul>
  <li>Not capture the <b>right functional</b> form correctly might also lead to biased estimations:</li>
  <ul>
...
<center><i>"Everything else equal, a <b>1 euro increase in annual household income</b> is associated with<br> an <b>increase of 0.003 gram in newborn birth weight</b> on average."</i></center>
...
<ul>
  ...
  <ul>
    ...
    <li>1 euro increase &#10140; 0.003 gram increase \(\Leftrightarrow\) <b>1,000 euro increase</b> &#10140; 3 gram increase</li>
  </ul>
</ul>
...
<ul>
  ...
  <ul>
    ...
    <li>Still continuous measure of <b>birth weight in grams</b></li>
  </ul>
</ul>
...
<center><i>"Everything else equal, a 1 [unit] increase in [x] is associated with<br> a [beta] percentage point [in/de]crease in the probability that [y equals 1] on average."</i></center>
...
<center><i>"Everything else equal, a <b>1 euro increase in annual household income</b> is associated with<br> a <b>0.0000004 percentage point decrease in the probability that the newborn is underweight</b> on average."</i></center>
...
<ul>
  ...
  <ul>
    <li>For a <b>1,000 euro</b> increase &#10140; 0.0004 percentage point decrease</li>
...
$$\begin{align}(15\div100) \times \widehat{\beta_{lvl}} &\approx (15\div100) \times `r beta_lvl` \\ &\approx `r 0.015 * beta_lvl` \end{align}$$
]
...
$$\begin{align}`r 0.015 * beta_lvl` \div90 &= `r sprintf("%.7f", (0.015 * beta_lvl) / 90)`\\ & \approx \beta_{log}\%\end{align}$$
]
...
<ul>
  ...
  <ul>
    <li>We've already seen that because income is log-normally distribution, it should be included in log</li>
  </ul>
</ul>
