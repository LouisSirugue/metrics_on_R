...
kable(regexpr_table %>% filter(row_number() %in% c(1:5, 10:13)), caption = "")
```
...
library(tidytext)
# Read the play
raj <- tibble(line = readLines("romeo_and_juliet.txt", encoding = "UTF-8"))
...
```{r, echo = F, fig.height = 4, fig.width = 5.505, out.width = "65%"}
ggplot() +
