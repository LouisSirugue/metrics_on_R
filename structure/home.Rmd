...
exs1 <- data.frame(a = c(" ", 
                 ...
                 b = c("Guidelines", 
                       paste0("[html](", root, "homework/guidelines.html) - [pdf](", root, "homework/guidelines.pdf)")),
                       
                 c = c("Source",
                       paste0("[Rmd](", root, "homework/homework.zip)")),
                 
                 d = c("Data", 
                       paste0("[data](https://www.aeaweb.org/articles?id=10.1257/aer.20130360)")))
...
<a href = "https://louissirugue.github.io/metrics_on_R/cheatsheets/moments.pdf"><img style = "margin-top:-2.3cm;margin-left:-1.45cm;" src = "../cheatsheets/moments.png" width = "100"/></a>
...
<a href = "https://louissirugue.github.io/metrics_on_R/cheatsheets/cartography.pdf"><img src = "../cheatsheets/cartography.png" width = "100"/></a>
<a href = "https://louissirugue.github.io/metrics_on_R/cheatsheets/sf.pdf"><img src = "../cheatsheets/sf.png" width = "100"/></a>
<a href = "https://louissirugue.github.io/metrics_on_R/cheatsheets/strings.pdf"><img src = "../cheatsheets/strings.png" width = "100"/></a>
...
<center><span style = "font-size:15pt;"><b>Fall semester</b></span></center>  
...
Online **quizzes** consist in sets of 3 to 5 short questions related to the content of the previous class. Links to the quizzes are available in the *Material* section of the course webpage. You will be able to log in to each quiz using the verification code I sent you via email. You will have the possibility to retry the quiz as many times as you want before submitting. But the quiz of a given lecture will be open from the end of that lecture and closed at the beginning of the following one. When you're done with a quiz you can click on *download results* and send the downloaded file to me by email. This is to keep track of your answers in case of disagreement about the grading.   

<p style = "margin-bottom:.75cm;"></p>

The **homework** is a set of exercises related to the first five lectures of the course. It can be done alone or by pairs, and must be handed over via email by the end of the sixth week (16<sup>th</sup> of October 23:59). Late submissions will be penalized by half a point for each 30min beyond the deadline. It is already available on the *Material* section of the course webpage, so I strongly encourage you to work on it progressively as we go the trough the course. The precise grading system of the homework is also available on the *Material* section of the course webpage already. You are very welcome to help each other, but you must write your answers yourselves. Copy-pasting is not permitted.  
...
<center><span style = "font-size:15pt;"><b>Spring semester</b></span></center>  

<p style = "margin-bottom:.75cm;"></p>

The grading of the second semester grade will be entirely based on your research project that you will carry out all along the semester. Research projects must be done by groups of two, so both members of a pair will have the same grade. You will be evaluated three times, at three different stages of the research process:
...
The homework is due by the 16<sup>th</sup> of October 23:59, and will be corrected in class during the 7<sup>th</sup> lecture.  
...
Horizontal dashed lines represent break periods. They all last 1 week except the 2-week-long Christmas break.

<p style = "margin-bottom:.75cm;"></p>

```{r s1, echo = FALSE}
s1 <- data.frame(c = c("05/09/22", 
                       "12/09/22", 
                       "19/09/22", 
                       "26/09/22",
                       "03/10/22", 
...
kable(s1, col.names = NULL, escape= F)  %>%
  ...
  row_spec(c(7, 10, 13, 14), extra_css = "border-bottom: dashed 1px #014D64 !important;") %>%
...
kable(s2, col.names = NULL, align = "lccl")  %>%
  ...
  column_spec(2, width = "5em", width_min = "4em", width_max = "4em") %>%
  column_spec(3, width = "5em", width_min = "4em", width_max = "4em") %>%
