...
<center><i>&#10140; We want to know whether anonymizing resumes helped reducing labor market discrimination toward the minority group</i></center>
 ...
 * How to characterize the <b>joint distribution<b> of <b>parent and child income?<b>
...
<ul>
  ...
  <ul>
    <li><b>Lower coefficients</b> for variables with <b>bigger metrics</b> (test scores)</li>
    <li><b>Higher coefficients</b> for variables with <b>smaller metrics</b> (fraction of single mothers)</li>
  </ul>
</ul>
...
<ul>
  <li>Structural papers are <b>more and more complex</b> on the theoretical side</li>
  <ul>
